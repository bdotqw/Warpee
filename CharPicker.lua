...
function Picker:RealmRow(n, y, realm, path)
  ...
  h.Text:SetTextColor(Theme:C(Theme:IsLight() and "dim" or "faint"))
...
function Picker:CharRow(n, y, e, path)
  ...
  r.Text:SetFont(path, 14, Theme:IsLight() and "" or "OUTLINE")
  local col = classColor(e.class)
  r.Text:SetText(e.name)
  local light = Theme:IsLight()
  if col and light then r.Text:SetTextColor(col.r * 0.55, col.g * 0.55, col.b * 0.55)
  elseif col then r.Text:SetTextColor(col.r, col.g, col.b)
  else r.Text:SetTextColor(Theme:C(light and "text" or "overlay")) end
  r.line:SetShown(light)
