...
local ITEMS_PAGE = {
  ...
  { type = "toggle", name = "Quality border", col = 2, get = qBorderGet, set = qBorderSet,
    desc = "A border around every item in its quality color. Quest items take the quest gold instead." },
  { type = "toggle", name = "Quest marker", col = 1, get = questGet, set = questSet,
    desc = "The game's exclamation mark on quests you have not picked up yet." },
