...
Theme.THEMES = {
  ...
  topaz = { label = "Topaz",
    bg = { 0.075, 0.052, 0.022, 0.960 }, panel = { 0.120, 0.085, 0.038, 1.000 },
    panelHi = { 0.165, 0.120, 0.055, 1.000 }, slot = { 0.088, 0.062, 0.029, 1.000 },
    stroke = { 0.230, 0.160, 0.065, 1.000 }, strokeSoft = { 0.178, 0.124, 0.051, 1.000 },
    accent = { 0.800, 0.250, 0.300, 1.000 }, accentInk = { 0.900, 0.500, 0.500, 1.000 },
    text = { 0.940, 0.910, 0.860, 1.000 }, dim = { 0.690, 0.630, 0.550, 1.000 },
    faint = { 0.480, 0.430, 0.360, 1.000 }, emptyLine = { 0.220, 0.170, 0.100, 1.000 },
    azure = { 0.350, 0.650, 0.620, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  sloe = { label = "Sloe",
    bg = { 0.055, 0.028, 0.055, 0.960 }, panel = { 0.090, 0.050, 0.090, 1.000 },
    panelHi = { 0.125, 0.072, 0.125, 1.000 }, slot = { 0.065, 0.036, 0.065, 1.000 },
    stroke = { 0.170, 0.095, 0.170, 1.000 }, strokeSoft = { 0.130, 0.073, 0.130, 1.000 },
    accent = { 0.880, 0.700, 0.420, 1.000 }, accentInk = { 0.940, 0.820, 0.600, 1.000 },
    text = { 0.930, 0.900, 0.930, 1.000 }, dim = { 0.670, 0.610, 0.670, 1.000 },
    faint = { 0.470, 0.420, 0.470, 1.000 }, emptyLine = { 0.200, 0.140, 0.190, 1.000 },
    azure = { 0.400, 0.750, 0.620, 1.000 }, reagent = { 0.400, 0.830, 0.610, 1.000 } },
  fen = { label = "Fen",
    bg = { 0.030, 0.045, 0.022, 0.960 }, panel = { 0.055, 0.078, 0.040, 1.000 },
    panelHi = { 0.080, 0.112, 0.058, 1.000 }, slot = { 0.040, 0.055, 0.030, 1.000 },
    stroke = { 0.110, 0.170, 0.075, 1.000 }, strokeSoft = { 0.085, 0.130, 0.058, 1.000 },
    accent = { 0.900, 0.650, 0.280, 1.000 }, accentInk = { 0.950, 0.780, 0.500, 1.000 },
    text = { 0.910, 0.930, 0.890, 1.000 }, dim = { 0.640, 0.680, 0.610, 1.000 },
    faint = { 0.440, 0.480, 0.420, 1.000 }, emptyLine = { 0.155, 0.190, 0.125, 1.000 },
    azure = { 0.550, 0.600, 0.900, 1.000 }, reagent = { 0.400, 0.830, 0.610, 1.000 } },
  cinder = { label = "Cinder",
    bg = { 0.065, 0.032, 0.022, 0.960 }, panel = { 0.105, 0.055, 0.038, 1.000 },
    panelHi = { 0.145, 0.080, 0.055, 1.000 }, slot = { 0.077, 0.040, 0.028, 1.000 },
    stroke = { 0.200, 0.100, 0.060, 1.000 }, strokeSoft = { 0.154, 0.077, 0.047, 1.000 },
    accent = { 0.450, 0.600, 0.850, 1.000 }, accentInk = { 0.620, 0.730, 0.920, 1.000 },
    text = { 0.930, 0.900, 0.850, 1.000 }, dim = { 0.670, 0.610, 0.530, 1.000 },
    faint = { 0.470, 0.420, 0.350, 1.000 }, emptyLine = { 0.200, 0.130, 0.085, 1.000 },
    azure = { 0.750, 0.480, 0.350, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  harbor = { label = "Harbor",
  ...
  grove = { label = "Grove",
    bg = { 0.085, 0.110, 0.055, 0.960 }, panel = { 0.128, 0.168, 0.085, 1.000 },
    panelHi = { 0.172, 0.225, 0.115, 1.000 }, slot = { 0.105, 0.138, 0.070, 1.000 },
    stroke = { 0.200, 0.320, 0.140, 1.000 }, strokeSoft = { 0.157, 0.252, 0.110, 1.000 },
    accent = { 0.880, 0.450, 0.250, 1.000 }, accentInk = { 0.940, 0.640, 0.460, 1.000 },
    text = { 0.930, 0.940, 0.900, 1.000 }, dim = { 0.680, 0.720, 0.650, 1.000 },
    faint = { 0.500, 0.540, 0.470, 1.000 }, emptyLine = { 0.230, 0.300, 0.190, 1.000 },
...
Theme.THEME_ORDER = { "midnight", "blizzard", "blizzardflat", "class",
                      ...
                      "topaz", "sloe", "fen", "cinder",
                      "harbor", "kiln", "grove", "velvet" }
