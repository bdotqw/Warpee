...
Theme.THEMES = {
  ...
  forest = { label = "Forest",
    ...
    azure = { 0.435, 0.714, 0.882, 1 }, reagent = { 0.451, 0.878, 0.812, 1 } },
  ...
  harbor = { label = "Harbor",
    ...
    panelHi = { 0.210, 0.265, 0.350, 1.000 }, slot = { 0.128, 0.165, 0.225, 1.000 },
    ...
    azure = { 0.250, 0.450, 0.800, 1.000 }, reagent = { 0.350, 0.720, 0.550, 1.000 } },
  kiln = { label = "Kiln",
    bg = { 0.125, 0.070, 0.045, 0.960 }, panel = { 0.185, 0.110, 0.072, 1.000 },
    panelHi = { 0.245, 0.150, 0.100, 1.000 }, slot = { 0.152, 0.090, 0.060, 1.000 },
    stroke = { 0.320, 0.170, 0.095, 1.000 }, strokeSoft = { 0.250, 0.135, 0.075, 1.000 },
    accent = { 0.250, 0.680, 0.620, 1.000 }, accentInk = { 0.500, 0.800, 0.730, 1.000 },
    text = { 0.950, 0.920, 0.880, 1.000 }, dim = { 0.710, 0.650, 0.580, 1.000 },
    faint = { 0.520, 0.460, 0.400, 1.000 }, emptyLine = { 0.300, 0.210, 0.140, 1.000 },
    azure = { 0.680, 0.520, 0.550, 1.000 }, reagent = { 0.350, 0.720, 0.550, 1.000 } },
  velvet = { label = "Velvet",
    bg = { 0.130, 0.075, 0.105, 0.960 }, panel = { 0.195, 0.115, 0.158, 1.000 },
    panelHi = { 0.260, 0.160, 0.210, 1.000 }, slot = { 0.160, 0.094, 0.130, 1.000 },
    stroke = { 0.330, 0.180, 0.260, 1.000 }, strokeSoft = { 0.260, 0.142, 0.205, 1.000 },
    ...
    azure = { 0.380, 0.720, 0.580, 1.000 }, reagent = { 0.400, 0.780, 0.550, 1.000 } },
  meadow = { label = "Meadow",
  ...
  brass = { label = "Brass",
    bg = { 0.150, 0.120, 0.070, 0.960 }, panel = { 0.215, 0.175, 0.108, 1.000 },
    panelHi = { 0.290, 0.240, 0.150, 1.000 }, slot = { 0.182, 0.148, 0.090, 1.000 },
    stroke = { 0.360, 0.280, 0.150, 1.000 }, strokeSoft = { 0.283, 0.221, 0.118, 1.000 },
    accent = { 0.220, 0.650, 0.600, 1.000 }, accentInk = { 0.480, 0.790, 0.710, 1.000 },
    text = { 0.960, 0.940, 0.900, 1.000 }, dim = { 0.710, 0.670, 0.600, 1.000 },
    faint = { 0.530, 0.490, 0.430, 1.000 }, emptyLine = { 0.330, 0.280, 0.190, 1.000 },
    azure = { 0.700, 0.500, 0.550, 1.000 }, reagent = { 0.350, 0.750, 0.550, 1.000 } },
  juniper = { label = "Juniper",
    bg = { 0.038, 0.050, 0.007, 0.960 }, panel = { 0.076, 0.089, 0.034, 1.000 },
    panelHi = { 0.111, 0.125, 0.072, 1.000 }, slot = { 0.071, 0.085, 0.028, 1.000 },
    stroke = { 0.119, 0.146, 0.011, 1.000 }, strokeSoft = { 0.099, 0.120, 0.020, 1.000 },
    accent = { 0.648, 0.671, 1.000, 1.000 }, accentInk = { 0.764, 0.791, 1.000, 1.000 },
    text = { 0.906, 0.912, 0.889, 1.000 }, dim = { 0.615, 0.627, 0.587, 1.000 },
    faint = { 0.405, 0.419, 0.369, 1.000 }, emptyLine = { 0.132, 0.151, 0.073, 1.000 },
    azure = { 0.737, 0.502, 0.303, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  reef = { label = "Reef",
    bg = { 0.004, 0.144, 0.157, 0.960 }, panel = { 0.059, 0.186, 0.199, 1.000 },
    panelHi = { 0.088, 0.206, 0.217, 1.000 }, slot = { 0.043, 0.183, 0.196, 1.000 },
    stroke = { 0.024, 0.251, 0.270, 1.000 }, strokeSoft = { 0.064, 0.220, 0.235, 1.000 },
    accent = { 0.793, 0.309, 0.459, 1.000 }, accentInk = { 0.822, 0.477, 0.565, 1.000 },
    text = { 0.919, 0.948, 0.951, 1.000 }, dim = { 0.611, 0.663, 0.668, 1.000 },
    faint = { 0.389, 0.454, 0.460, 1.000 }, emptyLine = { 0.138, 0.251, 0.262, 1.000 },
    azure = { 0.409, 0.624, 0.406, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  orchid = { label = "Orchid",
    bg = { 0.134, 0.105, 0.186, 0.960 }, panel = { 0.176, 0.148, 0.228, 1.000 },
    panelHi = { 0.190, 0.163, 0.241, 1.000 }, slot = { 0.172, 0.142, 0.226, 1.000 },
    stroke = { 0.244, 0.180, 0.348, 1.000 }, strokeSoft = { 0.213, 0.165, 0.296, 1.000 },
    accent = { 0.840, 0.749, 0.123, 1.000 }, accentInk = { 0.912, 0.853, 0.502, 1.000 },
    text = { 0.944, 0.937, 0.960, 1.000 }, dim = { 0.656, 0.644, 0.684, 1.000 },
    faint = { 0.446, 0.430, 0.480, 1.000 }, emptyLine = { 0.240, 0.214, 0.291, 1.000 },
    azure = { 0.316, 0.592, 0.776, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  marigold = { label = "Marigold",
    bg = { 0.077, 0.032, 0.007, 0.960 }, panel = { 0.117, 0.070, 0.033, 1.000 },
    panelHi = { 0.153, 0.107, 0.070, 1.000 }, slot = { 0.095, 0.048, 0.015, 1.000 },
    stroke = { 0.205, 0.103, 0.009, 1.000 }, strokeSoft = { 0.167, 0.087, 0.018, 1.000 },
    accent = { 0.000, 0.771, 0.934, 1.000 }, accentInk = { 0.485, 0.854, 0.968, 1.000 },
    text = { 0.926, 0.905, 0.889, 1.000 }, dim = { 0.650, 0.613, 0.586, 1.000 },
    faint = { 0.447, 0.402, 0.367, 1.000 }, emptyLine = { 0.190, 0.125, 0.071, 1.000 },
    azure = { 0.757, 0.457, 0.551, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  plum = { label = "Plum",
    bg = { 0.040, 0.004, 0.045, 0.960 }, panel = { 0.078, 0.025, 0.083, 1.000 },
    panelHi = { 0.095, 0.042, 0.100, 1.000 }, slot = { 0.075, 0.021, 0.080, 1.000 },
    stroke = { 0.157, 0.032, 0.169, 1.000 }, strokeSoft = { 0.121, 0.028, 0.131, 1.000 },
    accent = { 0.661, 0.809, 0.308, 1.000 }, accentInk = { 0.784, 0.896, 0.569, 1.000 },
    text = { 0.920, 0.902, 0.921, 1.000 }, dim = { 0.640, 0.609, 0.642, 1.000 },
    faint = { 0.435, 0.397, 0.437, 1.000 }, emptyLine = { 0.136, 0.082, 0.140, 1.000 },
    azure = { 0.439, 0.558, 0.802, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  pear = { label = "Pear",
    bg = { 0.094, 0.091, 0.005, 0.960 }, panel = { 0.134, 0.132, 0.042, 1.000 },
    panelHi = { 0.171, 0.171, 0.086, 1.000 }, slot = { 0.130, 0.128, 0.031, 1.000 },
    stroke = { 0.190, 0.187, 0.039, 1.000 }, strokeSoft = { 0.164, 0.162, 0.053, 1.000 },
    accent = { 0.352, 0.476, 0.851, 1.000 }, accentInk = { 0.488, 0.587, 0.853, 1.000 },
    text = { 0.943, 0.943, 0.920, 1.000 }, dim = { 0.654, 0.655, 0.613, 1.000 },
    faint = { 0.443, 0.444, 0.392, 1.000 }, emptyLine = { 0.196, 0.195, 0.112, 1.000 },
    azure = { 0.756, 0.485, 0.344, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  storm = { label = "Storm",
    bg = { 0.049, 0.084, 0.157, 0.960 }, panel = { 0.091, 0.126, 0.199, 1.000 },
    panelHi = { 0.129, 0.164, 0.236, 1.000 }, slot = { 0.084, 0.121, 0.197, 1.000 },
    stroke = { 0.102, 0.172, 0.326, 1.000 }, strokeSoft = { 0.095, 0.151, 0.270, 1.000 },
    accent = { 0.976, 0.629, 0.253, 1.000 }, accentInk = { 1.000, 0.763, 0.529, 1.000 },
  ...
  fern = { label = "Fern",
    bg = { 0.052, 0.145, 0.091, 0.960 }, panel = { 0.100, 0.187, 0.134, 1.000 },
    panelHi = { 0.144, 0.226, 0.174, 1.000 }, slot = { 0.091, 0.183, 0.127, 1.000 },
    stroke = { 0.043, 0.263, 0.153, 1.000 }, strokeSoft = { 0.074, 0.229, 0.143, 1.000 },
    accent = { 0.661, 0.401, 0.762, 1.000 }, accentInk = { 0.721, 0.541, 0.795, 1.000 },
    text = { 0.926, 0.948, 0.933, 1.000 }, dim = { 0.624, 0.663, 0.636, 1.000 },
    faint = { 0.405, 0.454, 0.421, 1.000 }, emptyLine = { 0.170, 0.251, 0.199, 1.000 },
    azure = { 0.633, 0.560, 0.257, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  dusk = { label = "Dusk",
    bg = { 0.065, 0.126, 0.195, 0.960 }, panel = { 0.110, 0.170, 0.237, 1.000 },
    panelHi = { 0.151, 0.209, 0.275, 1.000 }, slot = { 0.102, 0.165, 0.236, 1.000 },
    stroke = { 0.091, 0.225, 0.366, 1.000 }, strokeSoft = { 0.098, 0.200, 0.310, 1.000 },
    accent = { 0.965, 0.586, 0.342, 1.000 }, accentInk = { 0.997, 0.724, 0.561, 1.000 },
    text = { 0.927, 0.943, 0.963, 1.000 }, dim = { 0.626, 0.655, 0.688, 1.000 },
    faint = { 0.408, 0.444, 0.485, 1.000 }, emptyLine = { 0.177, 0.235, 0.300, 1.000 },
    azure = { 0.179, 0.636, 0.623, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  brick = { label = "Brick",
    bg = { 0.059, 0.002, 0.009, 0.960 }, panel = { 0.099, 0.020, 0.031, 1.000 },
    panelHi = { 0.121, 0.040, 0.052, 1.000 }, slot = { 0.077, 0.007, 0.016, 1.000 },
    stroke = { 0.198, 0.014, 0.058, 1.000 }, strokeSoft = { 0.154, 0.017, 0.045, 1.000 },
    accent = { 0.157, 0.805, 0.654, 1.000 }, accentInk = { 0.515, 0.877, 0.765, 1.000 },
    text = { 0.930, 0.901, 0.903, 1.000 }, dim = { 0.657, 0.607, 0.611, 1.000 },
    faint = { 0.455, 0.394, 0.399, 1.000 }, emptyLine = { 0.159, 0.076, 0.087, 1.000 },
    azure = { 0.642, 0.490, 0.735, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
}
Theme.THEME_ORDER = { "midnight", "blizzard", "blizzardflat", "class",
                      "nightbloom", "void", "nord",
                      "abyss", "blood", "forest", "graphite",
                      "harbor", "kiln", "velvet", "meadow", "brass",
                      "juniper", "reef", "orchid", "marigold", "plum",
                      "pear", "storm", "fern", "dusk", "brick" }
