...
Theme.THEMES = {
  ...
  lagoon = { label = "Lagoon",
    bg = { 0.043, 0.098, 0.114, 0.960 }, panel = { 0.075, 0.157, 0.180, 1.000 },
    panelHi = { 0.110, 0.208, 0.235, 1.000 }, slot = { 0.055, 0.118, 0.137, 1.000 },
    stroke = { 0.118, 0.302, 0.341, 1.000 }, strokeSoft = { 0.090, 0.230, 0.260, 1.000 },
    accent = { 0.870, 0.660, 0.300, 1.000 }, accentInk = { 0.950, 0.800, 0.500, 1.000 },
    text = { 0.890, 0.930, 0.930, 1.000 }, dim = { 0.600, 0.680, 0.690, 1.000 },
    faint = { 0.400, 0.470, 0.480, 1.000 }, emptyLine = { 0.240, 0.360, 0.380, 1.000 },
    azure = { 0.300, 0.550, 0.850, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  emberfall = { label = "Emberfall",
    bg = { 0.114, 0.063, 0.027, 0.960 }, panel = { 0.180, 0.102, 0.043, 1.000 },
    panelHi = { 0.247, 0.145, 0.063, 1.000 }, slot = { 0.133, 0.075, 0.031, 1.000 },
    stroke = { 0.361, 0.180, 0.071, 1.000 }, strokeSoft = { 0.270, 0.135, 0.055, 1.000 },
    accent = { 0.250, 0.850, 0.800, 1.000 }, accentInk = { 0.550, 0.920, 0.880, 1.000 },
    text = { 0.950, 0.920, 0.870, 1.000 }, dim = { 0.720, 0.640, 0.550, 1.000 },
    faint = { 0.500, 0.430, 0.350, 1.000 }, emptyLine = { 0.330, 0.220, 0.120, 1.000 },
    azure = { 0.420, 0.620, 0.850, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  matcha = { label = "Matcha",
    bg = { 0.048, 0.084, 0.029, 0.960 }, panel = { 0.088, 0.146, 0.052, 1.000 },
    panelHi = { 0.126, 0.196, 0.076, 1.000 }, slot = { 0.062, 0.104, 0.037, 1.000 },
    stroke = { 0.170, 0.335, 0.100, 1.000 }, strokeSoft = { 0.132, 0.257, 0.078, 1.000 },
    accent = { 0.950, 0.450, 0.200, 1.000 }, accentInk = { 0.980, 0.680, 0.450, 1.000 },
    text = { 0.900, 0.940, 0.870, 1.000 }, dim = { 0.620, 0.700, 0.590, 1.000 },
    faint = { 0.430, 0.490, 0.410, 1.000 }, emptyLine = { 0.235, 0.325, 0.185, 1.000 },
    azure = { 0.550, 0.600, 0.900, 1.000 }, reagent = { 0.400, 0.830, 0.610, 1.000 } },
  sakura = { label = "Sakura",
    bg = { 0.110, 0.047, 0.075, 0.960 }, panel = { 0.173, 0.078, 0.118, 1.000 },
    panelHi = { 0.235, 0.114, 0.161, 1.000 }, slot = { 0.129, 0.057, 0.088, 1.000 },
    stroke = { 0.341, 0.145, 0.227, 1.000 }, strokeSoft = { 0.260, 0.110, 0.170, 1.000 },
    accent = { 0.950, 0.780, 0.420, 1.000 }, accentInk = { 0.980, 0.870, 0.600, 1.000 },
    text = { 0.960, 0.910, 0.930, 1.000 }, dim = { 0.720, 0.620, 0.660, 1.000 },
    faint = { 0.500, 0.420, 0.460, 1.000 }, emptyLine = { 0.320, 0.200, 0.250, 1.000 },
    azure = { 0.350, 0.800, 0.650, 1.000 }, reagent = { 0.400, 0.830, 0.610, 1.000 } },
  ultraviolet = { label = "Ultraviolet",
    bg = { 0.048, 0.030, 0.105, 0.960 }, panel = { 0.085, 0.055, 0.175, 1.000 },
    panelHi = { 0.122, 0.082, 0.240, 1.000 }, slot = { 0.062, 0.039, 0.128, 1.000 },
    stroke = { 0.180, 0.115, 0.350, 1.000 }, strokeSoft = { 0.140, 0.090, 0.270, 1.000 },
    accent = { 0.650, 0.950, 0.250, 1.000 }, accentInk = { 0.800, 0.970, 0.500, 1.000 },
    text = { 0.920, 0.890, 0.960, 1.000 }, dim = { 0.660, 0.610, 0.740, 1.000 },
    faint = { 0.460, 0.420, 0.530, 1.000 }, emptyLine = { 0.215, 0.180, 0.300, 1.000 },
    azure = { 0.435, 0.706, 0.831, 1.000 }, reagent = { 0.400, 0.830, 0.610, 1.000 } },
  dune = { label = "Dune",
    bg = { 0.110, 0.086, 0.043, 0.960 }, panel = { 0.173, 0.137, 0.071, 1.000 },
    panelHi = { 0.235, 0.188, 0.098, 1.000 }, slot = { 0.129, 0.102, 0.051, 1.000 },
    stroke = { 0.345, 0.263, 0.114, 1.000 }, strokeSoft = { 0.260, 0.200, 0.090, 1.000 },
    accent = { 0.300, 0.800, 0.720, 1.000 }, accentInk = { 0.550, 0.880, 0.820, 1.000 },
    text = { 0.950, 0.920, 0.870, 1.000 }, dim = { 0.710, 0.660, 0.580, 1.000 },
    faint = { 0.500, 0.450, 0.380, 1.000 }, emptyLine = { 0.320, 0.270, 0.180, 1.000 },
    azure = { 0.300, 0.600, 0.700, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  wine = { label = "Wine",
    bg = { 0.068, 0.020, 0.048, 0.960 }, panel = { 0.112, 0.040, 0.082, 1.000 },
    panelHi = { 0.155, 0.062, 0.115, 1.000 }, slot = { 0.082, 0.026, 0.058, 1.000 },
    stroke = { 0.230, 0.080, 0.148, 1.000 }, strokeSoft = { 0.178, 0.062, 0.115, 1.000 },
    accent = { 0.880, 0.700, 0.450, 1.000 }, accentInk = { 0.950, 0.820, 0.620, 1.000 },
    text = { 0.950, 0.900, 0.910, 1.000 }, dim = { 0.710, 0.610, 0.640, 1.000 },
    faint = { 0.490, 0.420, 0.450, 1.000 }, emptyLine = { 0.240, 0.145, 0.195, 1.000 },
    azure = { 0.400, 0.750, 0.600, 1.000 }, reagent = { 0.400, 0.830, 0.610, 1.000 } },
  inkwell = { label = "Inkwell",
    bg = { 0.020, 0.024, 0.070, 0.960 }, panel = { 0.038, 0.045, 0.120, 1.000 },
    panelHi = { 0.058, 0.068, 0.170, 1.000 }, slot = { 0.026, 0.031, 0.085, 1.000 },
    stroke = { 0.080, 0.095, 0.260, 1.000 }, strokeSoft = { 0.062, 0.074, 0.200, 1.000 },
    accent = { 0.900, 0.720, 0.400, 1.000 }, accentInk = { 0.960, 0.830, 0.580, 1.000 },
    text = { 0.900, 0.910, 0.950, 1.000 }, dim = { 0.600, 0.630, 0.710, 1.000 },
    faint = { 0.410, 0.440, 0.510, 1.000 }, emptyLine = { 0.130, 0.150, 0.270, 1.000 },
    azure = { 0.750, 0.450, 0.400, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
}
Theme.THEME_ORDER = { "midnight", "blizzard", "blizzardflat", "class",
                      "nightbloom", "void", "nord",
                      "abyss", "blood", "forest", "graphite",
                      "lagoon", "emberfall", "matcha", "sakura",
                      "ultraviolet", "dune", "wine", "inkwell" }
