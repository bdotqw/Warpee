...
Theme.THEMES = {
  ...
  sakura = { label = "Sakura",
    bg = { 0.937, 0.882, 0.902, 0.94 }, panel = { 0.878, 0.792, 0.827, 1 },
    panelHi = { 0.831, 0.725, 0.773, 1 }, slot = { 0.957, 0.925, 0.937, 1 },
    stroke = { 0.694, 0.514, 0.588, 1 }, strokeSoft = { 0.804, 0.678, 0.729, 1 },
    accent = { 0.678, 0.216, 0.400, 1 }, accentInk = { 0.510, 0.145, 0.302, 1 },
    text = { 0.176, 0.125, 0.153, 1 }, dim = { 0.376, 0.290, 0.333, 1 },
    faint = { 0.549, 0.463, 0.510, 1 }, emptyLine = { 0.706, 0.600, 0.647, 1 },
    azure = { 0.216, 0.451, 0.361, 1 }, reagent = { 0.129, 0.416, 0.298, 1 },
    silver = { 0.353, 0.384, 0.427, 1 }, copper = { 0.573, 0.337, 0.196, 1 },
    gaugeLo = { 0.235, 0.478, 0.365, 1 }, gaugeHi = { 0.678, 0.235, 0.235, 1 } },
  bamboo = { label = "Bamboo",
    bg = { 0.906, 0.898, 0.831, 0.94 }, panel = { 0.839, 0.831, 0.729, 1 },
    panelHi = { 0.788, 0.776, 0.655, 1 }, slot = { 0.941, 0.937, 0.878, 1 },
    stroke = { 0.612, 0.600, 0.443, 1 }, strokeSoft = { 0.741, 0.729, 0.573, 1 },
    accent = { 0.325, 0.443, 0.161, 1 }, accentInk = { 0.235, 0.337, 0.106, 1 },
    text = { 0.145, 0.161, 0.114, 1 }, dim = { 0.322, 0.349, 0.243, 1 },
    faint = { 0.494, 0.514, 0.396, 1 }, emptyLine = { 0.663, 0.651, 0.510, 1 },
    azure = { 0.176, 0.396, 0.392, 1 }, reagent = { 0.129, 0.416, 0.255, 1 },
    silver = { 0.376, 0.396, 0.396, 1 }, copper = { 0.592, 0.361, 0.196, 1 },
    gaugeLo = { 0.298, 0.478, 0.286, 1 }, gaugeHi = { 0.639, 0.290, 0.212, 1 } },
}
