...
Theme.THEMES = {
  ...
  reef = { label = "Reef",
    ...
    stroke = { 0.073, 0.342, 0.365, 1.000 }, strokeSoft = { 0.017, 0.304, 0.327, 1.000 },
  ...
  frost = { label = "Frost",
    bg = { 0.008, 0.016, 0.032, 0.960 }, panel = { 0.070, 0.100, 0.140, 1.000 },
    panelHi = { 0.130, 0.175, 0.230, 1.000 }, slot = { 0.025, 0.045, 0.075, 1.000 },
    stroke = { 0.450, 0.550, 0.650, 1.000 }, strokeSoft = { 0.300, 0.380, 0.470, 1.000 },
    accent = { 0.950, 0.720, 0.420, 1.000 }, accentInk = { 0.980, 0.830, 0.600, 1.000 },
    text = { 1.000, 1.000, 1.000, 1.000 }, dim = { 0.780, 0.780, 0.780, 1.000 },
    faint = { 0.560, 0.560, 0.560, 1.000 }, emptyLine = { 0.400, 0.480, 0.560, 1.000 },
    azure = { 0.850, 0.450, 0.850, 1.000 }, reagent = { 0.350, 0.850, 0.550, 1.000 } },
  magma = { label = "Magma",
    bg = { 0.035, 0.012, 0.008, 0.960 }, panel = { 0.100, 0.060, 0.045, 1.000 },
    panelHi = { 0.170, 0.110, 0.085, 1.000 }, slot = { 0.055, 0.028, 0.020, 1.000 },
    stroke = { 0.550, 0.320, 0.240, 1.000 }, strokeSoft = { 0.380, 0.220, 0.170, 1.000 },
    accent = { 1.000, 0.550, 0.150, 1.000 }, accentInk = { 1.000, 0.720, 0.420, 1.000 },
    text = { 1.000, 1.000, 1.000, 1.000 }, dim = { 0.780, 0.780, 0.780, 1.000 },
  ...
  ice = { label = "Ice",
    ...
    panelHi = { 0.745, 0.787, 0.832, 1.000 }, slot = { 0.542, 0.578, 0.616, 1.000 },
    stroke = { 0.366, 0.443, 0.524, 1.000 }, strokeSoft = { 0.509, 0.569, 0.632, 1.000 },
    accent = { 0.000, 0.391, 0.709, 1.000 }, accentInk = { 0.000, 0.103, 0.234, 1.000 },
...
Theme.THEME_ORDER = { "midnight", "blizzard", "blizzardflat",
                      ...
                      "harbor", "velvet", "meadow", "reef", "parchment", "ice", "storm", "plum",
                      "fel", "contrast", "frost", "magma" }
Theme.LIGHT = { blizzard = true, blizzardflat = true, nord = true, harbor = true, meadow = true, reef = true, parchment = true, ice = true }
...
local LIGHT_CLASS_INK = {
  WARRIOR = { 0.527, 0.076, 0.001 }, PALADIN = { 0.513, 0.001, 0.317 },
  HUNTER = { 0.294, 0.295, 0.001 }, ROGUE = { 0.336, 0.277, 0.001 },
  PRIEST = { 0.333, 0.333, 0.373 }, DEATHKNIGHT = { 0.536, 0.001, 0.166 },
  SHAMAN = { 0.001, 0.287, 0.507 }, MAGE = { 0.001, 0.309, 0.416 },
  WARLOCK = { 0.283, 0.001, 0.737 }, MONK = { 0.001, 0.337, 0.213 },
  DRUID = { 0.435, 0.212, 0.001 }, DEMONHUNTER = { 0.367, 0.001, 0.650 },
  EVOKER = { 0.001, 0.333, 0.255 },
}
