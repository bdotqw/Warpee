...
Theme.THEMES = {
  ...
  foundry = { label = "Foundry",
    bg = { 0.026, 0.082, 0.104, 0.960 }, panel = { 0.048, 0.132, 0.164, 1.000 },
    panelHi = { 0.072, 0.180, 0.220, 1.000 }, slot = { 0.035, 0.096, 0.120, 1.000 },
    stroke = { 0.080, 0.255, 0.305, 1.000 }, strokeSoft = { 0.062, 0.196, 0.234, 1.000 },
    accent = { 0.850, 0.520, 0.250, 1.000 }, accentInk = { 0.930, 0.700, 0.450, 1.000 },
    text = { 0.900, 0.930, 0.930, 1.000 }, dim = { 0.600, 0.670, 0.680, 1.000 },
    faint = { 0.400, 0.460, 0.470, 1.000 }, emptyLine = { 0.165, 0.305, 0.335, 1.000 },
    azure = { 0.400, 0.600, 0.850, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  peat = { label = "Peat",
    bg = { 0.075, 0.052, 0.030, 0.960 }, panel = { 0.120, 0.085, 0.050, 1.000 },
    panelHi = { 0.165, 0.120, 0.072, 1.000 }, slot = { 0.088, 0.062, 0.037, 1.000 },
    stroke = { 0.240, 0.165, 0.085, 1.000 }, strokeSoft = { 0.185, 0.128, 0.066, 1.000 },
    accent = { 0.300, 0.780, 0.700, 1.000 }, accentInk = { 0.550, 0.870, 0.800, 1.000 },
    text = { 0.930, 0.900, 0.850, 1.000 }, dim = { 0.680, 0.620, 0.540, 1.000 },
    faint = { 0.470, 0.420, 0.350, 1.000 }, emptyLine = { 0.230, 0.180, 0.120, 1.000 },
    azure = { 0.420, 0.620, 0.850, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  marsh = { label = "Marsh",
    bg = { 0.060, 0.075, 0.035, 0.960 }, panel = { 0.100, 0.122, 0.058, 1.000 },
    panelHi = { 0.140, 0.168, 0.082, 1.000 }, slot = { 0.072, 0.090, 0.042, 1.000 },
    stroke = { 0.190, 0.235, 0.095, 1.000 }, strokeSoft = { 0.146, 0.180, 0.074, 1.000 },
    accent = { 0.900, 0.450, 0.220, 1.000 }, accentInk = { 0.960, 0.680, 0.450, 1.000 },
    text = { 0.920, 0.930, 0.890, 1.000 }, dim = { 0.660, 0.680, 0.610, 1.000 },
    faint = { 0.460, 0.470, 0.420, 1.000 }, emptyLine = { 0.230, 0.245, 0.160, 1.000 },
    azure = { 0.400, 0.620, 0.850, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
  jungle = { label = "Jungle",
    bg = { 0.020, 0.072, 0.060, 0.960 }, panel = { 0.038, 0.112, 0.094, 1.000 },
    panelHi = { 0.056, 0.154, 0.128, 1.000 }, slot = { 0.027, 0.082, 0.070, 1.000 },
    stroke = { 0.060, 0.225, 0.165, 1.000 }, strokeSoft = { 0.046, 0.173, 0.127, 1.000 },
    accent = { 0.880, 0.680, 0.320, 1.000 }, accentInk = { 0.940, 0.800, 0.520, 1.000 },
    text = { 0.900, 0.930, 0.900, 1.000 }, dim = { 0.620, 0.680, 0.640, 1.000 },
    faint = { 0.420, 0.470, 0.440, 1.000 }, emptyLine = { 0.125, 0.255, 0.195, 1.000 },
    azure = { 0.450, 0.600, 0.820, 1.000 }, reagent = { 0.353, 0.804, 0.616, 1.000 } },
}
Theme.THEME_ORDER = { "midnight", "blizzard", "blizzardflat", "class",
                      "nightbloom", "void", "nord",
                      "abyss", "blood", "forest", "graphite",
                      "wine", "inkwell", "foundry", "peat",
                      "marsh", "jungle" }
