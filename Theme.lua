...
Theme.THEMES = {
  ...
  mist = { label = "Mist",
    bg = { 0.140, 0.170, 0.220, 0.960 }, panel = { 0.180, 0.215, 0.280, 1.000 },
    panelHi = { 0.270, 0.315, 0.395, 1.000 }, slot = { 0.170, 0.205, 0.265, 1.000 },
    stroke = { 0.290, 0.380, 0.500, 1.000 }, strokeSoft = { 0.230, 0.300, 0.400, 1.000 },
    accent = { 0.950, 0.700, 0.350, 1.000 }, accentInk = { 0.980, 0.820, 0.550, 1.000 },
    text = { 0.980, 0.990, 1.000, 1.000 }, dim = { 0.720, 0.750, 0.800, 1.000 },
    faint = { 0.540, 0.580, 0.640, 1.000 }, emptyLine = { 0.320, 0.400, 0.500, 1.000 },
    azure = { 0.250, 0.450, 0.800, 1.000 }, reagent = { 0.350, 0.750, 0.550, 1.000 } },
  sand = { label = "Sand",
    bg = { 0.180, 0.155, 0.110, 0.960 }, panel = { 0.220, 0.190, 0.140, 1.000 },
    panelHi = { 0.330, 0.290, 0.215, 1.000 }, slot = { 0.215, 0.185, 0.135, 1.000 },
    stroke = { 0.420, 0.340, 0.200, 1.000 }, strokeSoft = { 0.330, 0.270, 0.165, 1.000 },
    accent = { 0.800, 0.280, 0.220, 1.000 }, accentInk = { 0.930, 0.550, 0.400, 1.000 },
    text = { 0.980, 0.970, 0.940, 1.000 }, dim = { 0.750, 0.710, 0.650, 1.000 },
    faint = { 0.570, 0.530, 0.470, 1.000 }, emptyLine = { 0.380, 0.330, 0.240, 1.000 },
    azure = { 0.300, 0.600, 0.650, 1.000 }, reagent = { 0.350, 0.750, 0.550, 1.000 } },
  sage = { label = "Sage",
    bg = { 0.110, 0.150, 0.100, 0.960 }, panel = { 0.150, 0.205, 0.138, 1.000 },
    panelHi = { 0.220, 0.290, 0.195, 1.000 }, slot = { 0.135, 0.185, 0.122, 1.000 },
    stroke = { 0.250, 0.420, 0.250, 1.000 }, strokeSoft = { 0.195, 0.330, 0.195, 1.000 },
    accent = { 0.900, 0.500, 0.300, 1.000 }, accentInk = { 0.960, 0.700, 0.500, 1.000 },
    text = { 0.950, 0.970, 0.940, 1.000 }, dim = { 0.700, 0.760, 0.690, 1.000 },
    faint = { 0.520, 0.580, 0.520, 1.000 }, emptyLine = { 0.280, 0.400, 0.280, 1.000 },
    azure = { 0.450, 0.600, 0.850, 1.000 }, reagent = { 0.400, 0.780, 0.550, 1.000 } },
  blush = { label = "Blush",
    bg = { 0.170, 0.100, 0.130, 0.960 }, panel = { 0.250, 0.150, 0.195, 1.000 },
    panelHi = { 0.320, 0.200, 0.250, 1.000 }, slot = { 0.205, 0.122, 0.160, 1.000 },
    stroke = { 0.420, 0.220, 0.300, 1.000 }, strokeSoft = { 0.330, 0.175, 0.235, 1.000 },
    accent = { 0.880, 0.680, 0.320, 1.000 }, accentInk = { 0.950, 0.800, 0.550, 1.000 },
    text = { 0.970, 0.940, 0.950, 1.000 }, dim = { 0.750, 0.680, 0.710, 1.000 },
    faint = { 0.570, 0.500, 0.540, 1.000 }, emptyLine = { 0.380, 0.260, 0.310, 1.000 },
    azure = { 0.350, 0.750, 0.600, 1.000 }, reagent = { 0.400, 0.780, 0.550, 1.000 } },
  clay = { label = "Clay",
    bg = { 0.160, 0.100, 0.070, 0.960 }, panel = { 0.240, 0.155, 0.110, 1.000 },
    panelHi = { 0.310, 0.205, 0.150, 1.000 }, slot = { 0.198, 0.128, 0.090, 1.000 },
    stroke = { 0.400, 0.230, 0.130, 1.000 }, strokeSoft = { 0.315, 0.185, 0.105, 1.000 },
    accent = { 0.250, 0.700, 0.650, 1.000 }, accentInk = { 0.500, 0.820, 0.750, 1.000 },
    text = { 0.960, 0.930, 0.890, 1.000 }, dim = { 0.730, 0.670, 0.600, 1.000 },
    faint = { 0.550, 0.490, 0.420, 1.000 }, emptyLine = { 0.360, 0.270, 0.180, 1.000 },
    azure = { 0.400, 0.600, 0.850, 1.000 }, reagent = { 0.350, 0.750, 0.550, 1.000 } },
  lilac = { label = "Lilac",
    bg = { 0.130, 0.110, 0.170, 0.960 }, panel = { 0.190, 0.165, 0.245, 1.000 },
    panelHi = { 0.260, 0.230, 0.325, 1.000 }, slot = { 0.160, 0.140, 0.205, 1.000 },
    stroke = { 0.310, 0.270, 0.420, 1.000 }, strokeSoft = { 0.245, 0.215, 0.330, 1.000 },
    accent = { 0.700, 0.900, 0.400, 1.000 }, accentInk = { 0.820, 0.950, 0.580, 1.000 },
    text = { 0.960, 0.940, 0.990, 1.000 }, dim = { 0.720, 0.690, 0.780, 1.000 },
    faint = { 0.540, 0.510, 0.600, 1.000 }, emptyLine = { 0.330, 0.300, 0.420, 1.000 },
    azure = { 0.400, 0.600, 0.850, 1.000 }, reagent = { 0.400, 0.780, 0.550, 1.000 } },
}
Theme.THEME_ORDER = { "midnight", "blizzard", "blizzardflat", "class",
                      "nightbloom", "void", "nord",
                      "abyss", "blood", "forest", "graphite",
                      "mist", "sand", "sage", "blush", "clay", "lilac" }
