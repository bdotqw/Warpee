...
Theme.THEMES = {
  ...
  sakura = { label = "Sakura",
    bg = { 0.937, 0.780, 0.839, 0.94 }, panel = { 0.898, 0.686, 0.769, 1 },
    panelHi = { 0.863, 0.600, 0.714, 1 }, slot = { 0.973, 0.882, 0.914, 1 },
    stroke = { 0.729, 0.404, 0.541, 1 }, strokeSoft = { 0.831, 0.573, 0.686, 1 },
    accent = { 0.596, 0.106, 0.333, 1 }, accentInk = { 0.451, 0.063, 0.243, 1 },
    text = { 0.180, 0.086, 0.129, 1 }, dim = { 0.376, 0.216, 0.286, 1 },
    faint = { 0.541, 0.376, 0.443, 1 }, emptyLine = { 0.706, 0.478, 0.580, 1 },
    azure = { 0.176, 0.400, 0.353, 1 }, reagent = { 0.110, 0.376, 0.271, 1 },
    silver = { 0.322, 0.353, 0.392, 1 }, copper = { 0.549, 0.310, 0.176, 1 },
    gaugeLo = { 0.204, 0.435, 0.337, 1 }, gaugeHi = { 0.639, 0.192, 0.204, 1 } },
  bamboo = { label = "Bamboo",
    bg = { 0.855, 0.878, 0.780, 0.94 }, panel = { 0.776, 0.808, 0.663, 1 },
    panelHi = { 0.722, 0.757, 0.588, 1 }, slot = { 0.925, 0.937, 0.855, 1 },
    stroke = { 0.541, 0.588, 0.376, 1 }, strokeSoft = { 0.678, 0.714, 0.518, 1 },
    accent = { 0.251, 0.400, 0.114, 1 }, accentInk = { 0.176, 0.294, 0.071, 1 },
    text = { 0.129, 0.153, 0.098, 1 }, dim = { 0.294, 0.333, 0.220, 1 },
    faint = { 0.463, 0.494, 0.361, 1 }, emptyLine = { 0.596, 0.631, 0.451, 1 },
    azure = { 0.129, 0.373, 0.369, 1 }, reagent = { 0.110, 0.392, 0.235, 1 },
    silver = { 0.353, 0.376, 0.376, 1 }, copper = { 0.561, 0.337, 0.180, 1 },
    gaugeLo = { 0.271, 0.443, 0.259, 1 }, gaugeHi = { 0.612, 0.263, 0.192, 1 } },
