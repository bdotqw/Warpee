...
local STRINGS = {
  ...
  ["Deposit"] = "Deposita",
  ["Withdraw"] = "Preleva",
  ["Deposit your bags into this bank"] = "Deposita le tue borse in questa banca",
  ["Deposit reagents"] = "Deposita reagenti",
  ["Deposit warbound items"] = "Deposita oggetti vincolati alla brigata",
  ["Include reagents"] = "Includi reagenti",
  ["Gold"] = "Oro",
  ["Log"] = "Registro",
  ...
  ["Reads the code in the field and replaces your list with it"] = "Legge il codice nel campo e sostituisce la tua lista con esso.",
