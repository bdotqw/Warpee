...
local STRINGS = {
  ...
  ["Reads the code in the field and asks before replacing your list; the list you had is kept as a profile, so it can be brought back"] = "Liest den Code im Feld und fragt, bevor deine Liste ersetzt wird; deine bisherige Liste wird als Profil aufbewahrt und kann zurückgeholt werden.",
