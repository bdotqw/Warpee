...
local STRINGS = {
  ...
  ["Deposit"] = "Ingresar",
  ["Withdraw"] = "Retirar",
  ["Deposit your bags into this bank"] = "Guarda tus bolsas en este banco",
  ["Deposit reagents"] = "Depositar reactivos",
  ["Deposit warbound items"] = "Depositar objetos de banda",
  ["Include reagents"] = "Incluir reactivos",
  ["Gold"] = "Oro",
  ["Log"] = "Registro",
  ...
  ["Reads the code in the field and replaces your list with it"] = "Lee el código del campo y reemplaza tu lista con él.",
