...
local STRINGS = {
  ...
  ["Reads the code in the field and asks before replacing your list; the list you had is kept as a profile, so it can be brought back"] = "Lit le code du champ et demande avant de remplacer votre liste ; la liste que vous aviez est conservée comme profil et peut être récupérée.",
